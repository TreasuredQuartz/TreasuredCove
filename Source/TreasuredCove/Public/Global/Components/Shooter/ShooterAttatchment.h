 ...
 */
UCLASS()
class TREASUREDCOVE_API UShooterAttatchmentDatabase : public UDataAsset
{
	GENERATED_BODY()

public:
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Shooter")
	TArray<TSubclassOf<UShooterAttatchment>> Database;
};
 ...
 */
UCLASS(Abstract)
class TREASUREDCOVE_API UShooterAttatchment : public UDataAsset
{
	GENERATED_BODY()
...
public:
	...
	*/
	...
	virtual float GetMass() const override
	{
		...
		return (TotalMass / 15432.f) + UShooterAttatchment::GetMass();
	};
