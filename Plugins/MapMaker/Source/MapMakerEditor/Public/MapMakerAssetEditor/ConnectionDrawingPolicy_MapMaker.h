 ...
 * 
 */
class MAPMAKEREDITOR_API FConnectionDrawingPolicy_MapMaker : public FConnectionDrawingPolicy
{
protected:
	UEdGraph* GraphObj;
...
public:
	FConnectionDrawingPolicy_MapMaker(int32 InBackLayerID, int32 InFrontLayerID, float ZoomFactor, const FSlateRect& InClippingRect, FSlateWindowElementList& InDrawElements, UEdGraph* InGraphObj);
