...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "RuntimeMesh|Rendering|Positions")
	static void AddPosition(UPARAM(ref) FRuntimeMeshVertexPositionStream& Stream, FRuntimeMeshVertexPositionStream& OutStream, FVector3f InPosition, int32& OutIndex);
	UFUNCTION(BlueprintCallable, Category = "RuntimeMesh|Rendering|Positions")
	...
	UFUNCTION(BlueprintCallable, Category = "RuntimeMesh|Rendering|Positions")
	static void GetPosition(UPARAM(ref) FRuntimeMeshVertexPositionStream& Stream, FRuntimeMeshVertexPositionStream& OutStream, int32 Index, FVector3f& OutPosition);
	UFUNCTION(BlueprintCallable, Category = "RuntimeMesh|Rendering|Positions")
	static void SetPosition(UPARAM(ref) FRuntimeMeshVertexPositionStream& Stream, FRuntimeMeshVertexPositionStream& OutStream, int32 Index, FVector3f NewPosition);
	UFUNCTION(BlueprintCallable, Category = "RuntimeMesh|Rendering|Positions")
	static void GetBounds(UPARAM(ref) FRuntimeMeshVertexPositionStream& Stream, FRuntimeMeshVertexPositionStream& OutStream, FBox3f& OutBounds);
	...
	UFUNCTION(BlueprintCallable, Category = "RuntimeMesh|Rendering|Tangents")
	static void AddNormalAndTangent(UPARAM(ref) FRuntimeMeshVertexTangentStream& Stream, FRuntimeMeshVertexTangentStream& OutStream, FVector3f InNormal, FVector3f InTangent, int32& OutIndex);
	UFUNCTION(BlueprintCallable, Category = "RuntimeMesh|Rendering|Tangents")
	static void AddTangents(UPARAM(ref) FRuntimeMeshVertexTangentStream& Stream, FRuntimeMeshVertexTangentStream& OutStream, FVector3f InTangentX, FVector3f InTangentY, FVector3f InTangentZ, int32& OutIndex);
	UFUNCTION(BlueprintCallable, Category = "RuntimeMesh|Rendering|Tangents")
	...
	UFUNCTION(BlueprintCallable, Category = "RuntimeMesh|Rendering|Tangents")
	static void GetNormal(UPARAM(ref) FRuntimeMeshVertexTangentStream& Stream, FRuntimeMeshVertexTangentStream& OutStream, int32 Index, FVector3f& OutNormal);
	UFUNCTION(BlueprintCallable, Category = "RuntimeMesh|Rendering|Tangents")
	static void SetNormal(UPARAM(ref) FRuntimeMeshVertexTangentStream& Stream, FRuntimeMeshVertexTangentStream& OutStream, int32 Index, FVector3f NewNormal);
	UFUNCTION(BlueprintCallable, Category = "RuntimeMesh|Rendering|Tangents")
	static void GetTangent(UPARAM(ref) FRuntimeMeshVertexTangentStream& Stream, FRuntimeMeshVertexTangentStream& OutStream, int32 Index, FVector3f& OutTangent);
	UFUNCTION(BlueprintCallable, Category = "RuntimeMesh|Rendering|Tangents")
	static void SetTangent(UPARAM(ref) FRuntimeMeshVertexTangentStream& Stream, FRuntimeMeshVertexTangentStream& OutStream, int32 Index, FVector3f NewTangent);
	UFUNCTION(BlueprintCallable, Category = "RuntimeMesh|Rendering|Tangents")
	static void GetTangents(UPARAM(ref) FRuntimeMeshVertexTangentStream& Stream, FRuntimeMeshVertexTangentStream& OutStream, int32 Index, FVector3f& OutTangentX, FVector3f& OutTangentY, FVector3f& OutTangentZ);
	UFUNCTION(BlueprintCallable, Category = "RuntimeMesh|Rendering|Tangents")
	static void SetTangents(UPARAM(ref) FRuntimeMeshVertexTangentStream& Stream, FRuntimeMeshVertexTangentStream& OutStream, int32 Index, FVector3f InTangentX, FVector3f InTangentY, FVector3f InTangentZ);
	...
	UFUNCTION(BlueprintCallable, Category = "RuntimeMesh|Rendering|TextureCoordinates")
	static void AddTexCoord(UPARAM(ref) FRuntimeMeshVertexTexCoordStream& Stream, FRuntimeMeshVertexTexCoordStream& OutStream, int32& OutIndex, FVector2f InTexCoord, int32 ChannelId = 0);
	UFUNCTION(BlueprintCallable, Category = "RuntimeMesh|Rendering|TextureCoordinates")
	...
	UFUNCTION(BlueprintCallable, Category = "RuntimeMesh|Rendering|TextureCoordinates")
	static void GetTexCoord(UPARAM(ref) FRuntimeMeshVertexTexCoordStream& Stream, FRuntimeMeshVertexTexCoordStream& OutStream, int32 Index, int32 ChannelId, FVector2f& OutTexCoord);
	UFUNCTION(BlueprintCallable, Category = "RuntimeMesh|Rendering|TextureCoordinates")
	static void SetTexCoord(UPARAM(ref) FRuntimeMeshVertexTexCoordStream& Stream, FRuntimeMeshVertexTexCoordStream& OutStream, int32 Index, FVector2f NewTexCoord, int32 ChannelId = 0);
	...
	UFUNCTION(BlueprintCallable, Category = "RuntimeMesh|Collision|Vertices")
	static void GetCollisionVertex(UPARAM(ref) FRuntimeMeshCollisionVertexStream& Stream, FRuntimeMeshCollisionVertexStream& OutStream, int32 Index, FVector3f& OutVertex);
	UFUNCTION(BlueprintCallable, Category = "RuntimeMesh|Collision|Vertices")
	static void SetCollisionVertex(UPARAM(ref) FRuntimeMeshCollisionVertexStream& Stream, FRuntimeMeshCollisionVertexStream& OutStream, int32 Index, FVector3f NewVertex);
	...
	UFUNCTION(BlueprintCallable, Category = "RuntimeMesh|Collision|TextureCoordinates")
	static void AddCollisionTexCoord(UPARAM(ref) FRuntimeMeshVertexTexCoordStream& Stream, FRuntimeMeshVertexTexCoordStream& OutStream, FVector2f InTexCoord, int32& OutIndex);
	UFUNCTION(BlueprintCallable, Category = "RuntimeMesh|Collision|TextureCoordinates")
	static void GetCollisionTexCoord(UPARAM(ref) FRuntimeMeshVertexTexCoordStream& Stream, FRuntimeMeshVertexTexCoordStream& OutStream, int32 Index, FVector2f& OutTexCoord, int32 ChannelId = 0);
	UFUNCTION(BlueprintCallable, Category = "RuntimeMesh|Collision|TextureCoordinates")
	static void SetCollisionTexCoord(UPARAM(ref) FRuntimeMeshVertexTexCoordStream& Stream, FRuntimeMeshVertexTexCoordStream& OutStream, int32 Index, FVector2f NewTexCoord, int32 ChannelId = 0);
